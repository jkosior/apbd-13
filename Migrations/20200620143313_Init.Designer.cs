...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("apbd13.Models.Klient", b =>
                {
            ...
            modelBuilder.Entity("apbd13.Models.Pracownik", b =>
                {
            ...
            modelBuilder.Entity("apbd13.Models.WyrobCukierniczy", b =>
                {
            ...
            modelBuilder.Entity("apbd13.Models.Zamowienie", b =>
                {
            ...
            modelBuilder.Entity("apbd13.Models.ZamowienieWyrobCukierniczy", b =>
                {
            ...
            modelBuilder.Entity("apbd13.Models.Zamowienie", b =>
                {
                    b.HasOne("apbd13.Models.Klient", "Klient")
                        .WithMany("Zamowienia")
                        .HasForeignKey("KlientIdKlient");

                    b.HasOne("apbd13.Models.Pracownik", "Pracownik")
                        .WithMany("Zamowienia")
            ...
            modelBuilder.Entity("apbd13.Models.ZamowienieWyrobCukierniczy", b =>
                {
                    b.HasOne("apbd13.Models.WyrobCukierniczy", "WyrobCukierniczy")
                        .WithMany("ZamowieniaWyrobCukiernicze")
                        .HasForeignKey("IdWyrobCukierniczy")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("apbd13.Models.Zamowienie", "Zamowienie")
